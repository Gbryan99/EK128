...
def button_small(msg,x,y,w,h,inactColor,actColor,action=None): #same as button function but for buttons with smaller texts (ie size 10 fonts)
...
def game_loop():
    ...
    while not gameExit:
        ...
        gameDisplay.fill(yellow, rect=[30,30, 150, 150]) #This draws a yellow box (which will act as a flashcard) AnsOption1
